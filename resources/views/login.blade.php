...
<head>
    ...
    <title>Login - PRF Leave Management System</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="shortcut icon" href="{{ asset('assets/img/prf_icon.png') }}" />
    <link href="css2?family=Nunito:wght@400;500;600;700;800&display=swap" rel="stylesheet">
    <link rel="stylesheet" type="text/css" media="screen" href="{{ asset('login/css/style.css') }}">
</head>
    ...
    <div class="main-container min-h-screen text-black dark:text-white-dark">
        <div x-data="auth">
            <div class="absolute inset-0">
                <img src="{{ asset('login/images/auth/bg-gradient.png') }}" alt="image"
            ...
            <div
                ...
                <img src="{{ asset('login/images/auth/coming-soon-object1.png') }}" alt="image"
                    class="absolute left-0 top-1/2 h-full max-h-[893px] -translate-y-1/2">
                <img src="{{ asset('login/images/auth/coming-soon-object2.png') }}" alt="image"
                    class="absolute left-24 top-0 h-40 md:left-[30%]">
                <img src="{{ asset('login/images/auth/coming-soon-object3.png') }}" alt="image"
                    class="absolute right-0 top-0 h-[300px]">
                <img src="{{ asset('login/images/auth/polygon-object.svg') }}" alt="image"
                        ...
                        <div class="mx-auto w-full max-w-[440px]">
                            <div class="mb-10">
                                <h1 class="text-3xl font-extrabold uppercase !leading-snug text-primary md:text-4xl">
                                    Sign in</h1>
                                <p class="text-base font-bold leading-normal text-white-dark">PRF Leave Management
                                    System</p>
                            </div>
                            <form class="space-y-5 dark:text-white" action="{{ url('/store-login') }}" method="POST">
                                @csrf
                                <div>
