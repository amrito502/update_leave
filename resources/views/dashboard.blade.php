                        ...
                        <ul class="project-activity">
                            ...
                            <li class="activity-list success">
                                <div class="detail-info">
                                    ...
                                    <p class="info">Send email notifications of subscriptions and deletions to list
                                        owner.</p>
                                </div>
                            </li>
                        ...
                        <ul class="user-messages">
                            <li class="clearfix">
                                ...
                                <div class="delivery-details">
                                    ...
                                    <h5>Aaleyah Malik</h5>
                                    <p>We are pleased to inform that the following ticket no. <b>Le Rouge510</b> have been
                                        booked.</p>
                                </div>
                            </li>
                            <li class="clearfix">
                            ...
                            <li class="clearfix">
                                ...
                                <div class="delivery-details">
                                    ...
                                    <h5>Zaira Raheem</h5>
                                    <p>The following describe the status codes and messages states for delivery receipts.
                                    </p>
                                </div>
                            </li>
                            <li class="clearfix">
                                ...
                                <div class="delivery-details">
                                    ...
                                    <h5>Lily Jordan</h5>
                                    <p>Status codes and descriptions are returned in the following OpenMarket-specific TLVs
                                        When a delivery receipt is received.</p>
                                </div>
                            </li>
                        </ul>
                    </div>
